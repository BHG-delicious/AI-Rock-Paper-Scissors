...
一個讓兩個AI模型互相對戰剪刀石頭布的網頁遊戲，通常採用9戰5勝制。
...
### 1. 設定AI玩家
- 輸入兩個AI的名稱（如：ChatGPT、Gemini、DeepSeek）
- 選擇AI模型類型
- 描述各自的策略風格
...
[立即開始](https://bhg-delicious.github.io/AI-Rock-Paper-Scissors/)你的AI對戰吧！ 🎮
